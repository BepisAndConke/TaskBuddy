package nl.fontys.TaskBuddy.configuration.security.auth;

import nl.fontys.TaskBuddy.configuration.security.token.AccessTokenDecoder;
import nl.fontys.TaskBuddy.configuration.security.token.exception.InvalidAccessTokenException;
...
public class AuthenticationRequestFilter extends OncePerRequestFilter {
    ...
    private void setupSpringSecurityContext(AccessToken accessToken) {
        UserDetails userDetails = new User(accessToken.getSubject(), "",
                Collections.singletonList(new SimpleGrantedAuthority(SPRING_SECURITY_ROLE_PREFIX + accessToken.getRole())));
